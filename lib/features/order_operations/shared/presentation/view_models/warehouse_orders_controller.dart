...
class WarehouseOrdersController extends ChangeNotifier with SafeChangeNotifier {
  WarehouseOrdersController({
    required WarehouseOrdersRepository repository,
  ...
  final WarehouseOrdersRepository _repository;
  ...
  String? _detailError;
  String? _createError;
  List<WarehouseOrderListItem> _orders = const <WarehouseOrderListItem>[];
  WarehouseOrderListItem? _selectedOrder;
  WarehouseOrderDetail? _selectedOrderDetail;
  ...
  List<WarehouseOrderListItem> get orders => _orders;
  WarehouseOrderListItem? get selectedOrder => _selectedOrder;
  WarehouseOrderDetail? get selectedOrderDetail => _selectedOrderDetail;
  ...
  Future<void> loadOrders({
    ...
    try {
      ...
      if (_selectedOrder != null) {
        await selectOrder(_selectedOrder!);
      }
    } on ApiException catch (error) {
      if (!_listEpoch.isCurrent(listRequestId)) {
        return;
      }
      _orders = const <WarehouseOrderListItem>[];
      _selectedOrder = null;
      _selectedOrderDetail = null;
      _isLoadingList = false;
  ...
  Future<void> selectOrder(WarehouseOrderListItem item) async {
  ...
  WarehouseOrderListItem? _findPreferredOrder(
    List<WarehouseOrderListItem> items, {
    String? preferredDocumentSerie,
    int? preferredDocumentOrderNo,
  }) {
